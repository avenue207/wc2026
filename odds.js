...
const MATCHES = [
  ...
  { id:"H2", stage:"GRP", date:"Jun 15", group:"Group H", venue:"Miami",
    ...
    ah:{ line:-0.5, homeLabel:"KSA -0.5", awayLabel:"URU +0.5", homePayout:1.7, awayPayout:2.4 },
    simHomeWin:40, simCoverAH:23, marketCoverAH:59, edge:-36,
    notes:"Uruguay (Valverde, Nunez, Araujo) 60% win, KSA 40%. KSA +1.25 covers if they lose by <=1 - 65% of sims.",
    rec:"strong", recLabel:"🔥 Back URU +0.5", recDetail:"Underdog covers 77% — strong value on URU." },
